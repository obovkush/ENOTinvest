    ...
    <>
      {stocks &&
        stocks.map((el, index) => {
          return (
            <Accordion
              expanded={expanded === `panel${el.secid}`}
              onChange={handleChange(`panel${el.secid}`)}
              key={el.secid}
            >
              <Badge.Ribbon
                placement="start"
              ...
              <AccordionDetails>
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={6}>
                    <Typography>Информация о компании</Typography>
                    <br />
                    <Typography sx={{ fontSize: 12 }}>
                      ПАО Сберба́нк — российский финансовый конгломерат,
                      крупнейший универсальный банк России и Восточной Европы.
                      По итогам 2019 года у Сбербанка 96,2 миллионов активных
                      частных клиентов и 2,6 миллиона активных корпоративных
                      клиентов. Среди крупнейших банков мира по размеру активов
                      находится в восьмом десятке. Включён Банком России в
                      перечень системно значимых кредитных организаций.
                      Владельцем 50 % плюс 1 акция ПАО «Сбербанк» является Фонд
                      национального благосостояния России, контролируемый
                      Правительством России, остальные акции находятся в
                      публичном обращении. Рыночная капитализация на август 2021
                      года составляла 7,3 триллиона рублей. В 2021 году ценность
                      бренда Сбербанка выросла до 730,6 миллиардов рублей. С
                      2017 года Сбербанк удерживает первую позицию в рейтинге
                      наиболее дорогих брендов в России, который составляет
                      компания Brand Finance. Сбербанк — самый востребованный
                      банк среди розничных клиентов, его услугами пользуется
                      большинство жителей России, его объёмы розничного бизнеса
                      в несколько раз больше ближайшего конкурента — «Банка
                      ВТБ».
                    </Typography>
                  </Grid>
                </Grid>
